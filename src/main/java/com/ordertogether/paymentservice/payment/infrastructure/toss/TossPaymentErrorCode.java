...
public enum TossPaymentErrorCode {
    ...
    BELOW_MINIMUM_AMOUNT(400, "결제 가능한 최소 금액 미만입니다."),
    ...
    EXCEED_MAX_MONTHLY_PAYMENT_AMOUNT(400, "당월 결제 가능 금액을 초과했습니다."),
    ...
    REJECT_TOSSPAY_INVALID_ACCOUNT(403, "출금 계좌가 등록되어 있지 않습니다."),
    ...
    INCORRECT_BASIC_AUTH_FORMAT(403, "잘못된 인증 요청 형식입니다."),
    FDS_ERROR(403, "위험 거래가 감지되어 결제가 제한되었습니다."),
    ...
    FAILED_PAYMENT_INTERNAL_SYSTEM_PROCESSING(500, "결제가 완료되지 않았습니다. 다시 시도해주세요."),
    FAILED_INTERNAL_SYSTEM_PROCESSING(500, "내부 시스템 처리 작업이 실패했습니다."),
    UNKNOWN_PAYMENT_ERROR(500, "결제에 실패했습니다."),

    UNKNOWN(500, "알 수 없는 오류입니다."); // 예외 처리용
